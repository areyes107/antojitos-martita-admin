...
import ImageModalCombo from "../image-modal-combo/image-modal-combo.component";
...
const AddCombo = () => {
  ...
  useEffect(() => {
    async function CreateUrl() {
      const rawData = await firebase.storage().ref("combos").listAll();
        ...
        <form onSubmit={handleSubmit} className={classes.form}>
          <div className={classes.data}>
            ...
            <CustomUploadButton
              accept="image/*"
              name="logo"
              storageRef={firebase.storage().ref("combos")}
              randomizeFilename
